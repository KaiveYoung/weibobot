...
blogurl=soup.find('div',class_="post hentry uncustomized-post-template").find('h3').find('a').attrs['href']
weather = requests.get("http://m.weather.com.cn/mweather/101170101.shtml")
chuanyi = requests.get("http://m.weather.com.cn/mzs/101170101.shtml?flag=ct")
...
soup3 = BeautifulSoup(blog.text,"lxml")
...
soup=BeautifulSoup(blog.text,'lxml')
image=soup.find('div',class_='post hentry uncustomized-post-template').find('meta').attrs['content']
